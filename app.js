...
require('./app/routes/query')(app, "/clientsEmpresa/:nameCliente?",
                              "Select ClienteEmpresa.nome from ClienteEmpresa, Cliente where ClienteEmpresa.empresa_id = Cliente.id and Cliente.nome = " + req.params.nameCliente);
